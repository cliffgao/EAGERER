...
class SPROF(nn.Module):
    def __init__(self, block):
        ...
        ###--64+150=214-> 64+21=85
        self.lstm = nn.LSTM(85, 64, 3, batch_first=True, bidirectional=True)
        self.fc1 = nn.Linear(64, 50)
        self.fc11 = nn.Linear(50, 40)
        self.fc2 = nn.Linear(128, 64)
        #self.fc3 = nn.Linear(64, 20)  #cliff
        self.fc3 = nn.Linear(64, 1)
        #self.fc4 = nn.Linear(64, 1)  #cliff
    ...
    def forward(self, x1, x2):
        ...
        o1 = torch.sum(out11, 2) / 40   #?40
        x1=x1.permute(0,2,1)
        #print(o1.shape,x1.shape)
        x = torch.cat([o1, x1], 1)
